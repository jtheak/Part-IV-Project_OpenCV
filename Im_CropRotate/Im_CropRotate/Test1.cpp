...
//		Mat crop(img, box);
//		
//		crop1 = crop; //Selecting a ROI(region of interest) from the original pic
//		namedWindow("Cropped Image", WINDOW_NORMAL);
//		imshow("Cropped Image", crop1); //showing the cropped image
//		leftDown = false;
//		leftup = false;
//
//	}
